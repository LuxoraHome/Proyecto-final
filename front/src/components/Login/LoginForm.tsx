                ...
                <Formik initialValues={{ email: "", password: "" }} validate={validateLogin} onSubmit={handelSubmit} >
                    <Form className="block w-full px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-blue-700 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 border m-2 ml-[-4px]" >
                        ...
                        <div>
                            ...
                            <Field name="email" type="text" className="block w-full border-black px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-blue-700 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 border m-2 ml-[-7px]" />
                            <ErrorMessage name="email" component="p" className="text-red-500 font-bold text-sm" />
                        </div>
    
                        <div>
                            <label className="px-2">Password:</label>
                            <Field name="password" type="password" className="block w-full border-black px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-blue-700 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 border m-2 ml-[-7px]" />
                        ...
                        <div className="flex flex-col items-center gap-4 p-4">
                            ...
                            <div className="flex flex-col items-center gap-6 p-6">
                                ...
                                <p className="font-bold text-lg text-gray-800" >
                                    ...
                                    <Link href="/register" className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 group">
                                        <span className="absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-gray-600 group-hover:w-full ease"></span>
                                        <span className="absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-gray-600 group-hover:w-full ease"></span>
                                        <span className="absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
                                        <span className="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
                            ...
                            <button onClick={handelOnClick} className="flex items-center gap-3 px-6 py-3 border-2 border-black shadow-md transition-transform duration-200 hover:scale-105">
