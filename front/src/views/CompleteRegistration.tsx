    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8">
      <div className="bg-white p-8  shadow-xl w-full sm:w-2/3 lg:w-2/3 xl:w-2/3 max-w-4xl">
        ...
        <div className="flex justify-between mt-6">
          <Link
            href="/"
            className="bg-transparent text-gray-700 py-2 px-6 border-2 border-gray-700 text-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400"
          >
            Continue Browsing
          </Link>
          <Link
            href="/formCompleteRegistration"
            className="bg-black text-white py-2 px-6 text-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black"
          >
            Finish Profile
          </Link>
        </div>
