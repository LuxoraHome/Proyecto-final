...
export const RegisterFormView: React.FC = () => {
  ...
  return (
    <div className="w-1/2 mx-auto p-6 bg-white border border-black rounded-xl shadow-lg mt-10 mb-20">
      ...
      <Formik
        initialValues={{ ...initialValues, termsAccepted: false }}
      ...
      >
        {({ isSubmitting }) => (
          <Form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-black text-white font-bold py-2 rounded hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
